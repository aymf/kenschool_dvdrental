...
<body>
	...
	<div>
		...
		<tr><td><a href="allGoodsList" class="menu">商品検索</a></td></tr>
		<tr><td><a href="vagueGoodsList" class="menu">あいまい検索</a></td></tr>
		<tr><td><a href="deptList" class="menu">部署一覧</a></td></tr>
		<tr><td><a href="regist" class="menu">従業員登録</a></td></tr>
		<tr><td><a href="memberList" class="menu">会員登録</a></td></tr>
		<tr><td><a href="change" class="menu">従業員変更／削除</a></td></tr>
		<tr><td><a href="changeMember" class="menu">会員登録内容変更／削除</a></td></tr>
		</table>
	</div>
</body>
</html>